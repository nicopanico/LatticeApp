function [vertices, to_evaluate] = findMaximum(CTinfo, zDim, distVertex_px, maskPTV_3D, reticolo3D,app)
...
for z=1:2:step_z2
    for i=1:2:step_x2
        for j=1:2:step_y2
            ...
            to_evaluate(cont,1)=sum(newreticolo.*maskPTV_3D==1,'all');%modifica andrea per velocizzare di un fattore >2
